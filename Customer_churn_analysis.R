...
telecomDataframe <- read.csv(file="Telco-Customer-Churn.csv")
...
# Check the structure of Churn variable
str(trainData$Churn)

# If Churn is a factor with levels "No" and "Yes"
# Convert it to factor if necessary (only if it's stored as character or numeric)
...
# Check the unique values again to confirm they are now binary
unique(trainData$Churn)
